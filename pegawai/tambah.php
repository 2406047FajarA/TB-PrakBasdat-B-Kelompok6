...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
 ...
 $q = "INSERT INTO pegawai (nip, nama, id_departemen, jabatan, gaji, no_hp,
email, tgl_masuk, status)
 VALUES
('$nip','$nama',$id_dept,'$jabatan',$gaji,'$no_hp','$email','$tgl_masuk','$status')";
...
<div class="container mt-4">
 <div class="mb-4">
 <a href="index.php" class="text-decoration-none text-muted small">← Kembali ke
Daftar Pegawai</a>
 ...
 <div class="row g-3">
 <div class="col-md-6">
 <label class="form-label fw-semibold">NIP <span class="textdanger">*</span></label>
 <input type="text" name="nip"
 value="<?= htmlspecialchars($_POST['nip'] ?? '') ?>"
 class="form-control font-monospace" placeholder="Contoh: 2024001">
 </div>
 <div class="col-md-6">
 <label class="form-label fw-semibold">Nama Lengkap <span class="textdanger">*</span></label>
 ...
 <label class="form-label fw-semibold">Departemen <span class="textdanger">*</span></label>
 <select name="id_departemen" class="form-select">
 <option value="">-- Pilih Departemen --</option>
 <?php while ($d = mysqli_fetch_assoc($deptList)): ?>
 <option value="<?= $d['id'] ?>"
 <?= (isset($_POST['id_departemen']) && $_POST['id_departemen'] ==
$d['id']) ? 'selected' : '' ?>>
 ...
 <div class="col-md-6">
 <label class="form-label fw-semibold">Jabatan <span class="textdanger">*</span></label>
 ...
 <div class="col-md-6">
 <label class="form-label fw-semibold">Tanggal Masuk <span class="textdanger">*</span></label>
 ...
 <option value="aktif" <?= (isset($_POST['status']) &&
$_POST['status']=='aktif') ? 'selected' : '' ?>>Aktif</option>
 <option value="nonaktif" <?= (isset($_POST['status']) &&
$_POST['status']=='nonaktif') ? 'selected' : '' ?>>Non-aktif</option>
 </select>
 </div>
 </div>
 <hr class="my-4">
 <div class="d-flex gap-2">
 <button type="submit" class="btn btn-primary fw-semibold px-4"> Simpan
Data</button>
